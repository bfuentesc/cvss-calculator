      ...
      >
        ...
        <Box sx={boxStyle}>
          ...
          <Typography variant="body2">
            The Exploitability metrics reflect the characteristics of the thing
            that is vulnerable, which we refer to formally as the vulnerable
            component. Therefore, each of the Exploitability metrics listed
            below should be scored relative to the vulnerable component, and
            reflect the properties of the vulnerability that lead to a
            successful attack.
          </Typography>
          {exploitabilityButtonConfigs.map((config, index) => (
            <AccordionMetrics
              ...
              handleChange={(_, key: string) => handleChange(config.key, key)}
            />
          ))}
        </Box>
        ...
        <Box sx={boxStyle}>
          ...
          <Typography variant="body2">
            ...
            vulnerability on the component that suffers the worst outcome that
            is most directly and predictably associated with the attack.
          </Typography>
